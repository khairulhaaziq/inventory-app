        ...
        <div className="table w-full space-y-1">
          <div className="table-header-group bg-[rgba(0,0,0,0.02)]">
            <div className="table-row text-neutral-500 text-sm [&>*]:h-12 [&>*]:table-cell">
              <div className="border-b border-neutral-300 px-5 w-[100px] max-w-1/6"><div className="flex items-center h-full"><button className="flex items-center gap-x-1 hover:text-neutral-600 tracking-wider font-medium uppercase" onClick={()=>handleSort('id')}>ID {sort === 'idAsc' ? <ArrowUpIcon /> : sort === 'idDesc' || !sort ? <ArrowDownIcon /> : '' }</button></div></div>
